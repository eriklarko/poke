...
class MockNotificationService extends _i1.Mock
  ...
  @override
  _i3.FutureOr<(String, DateTime)?> getScheduledNotificationForAction(
          String? actionId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getScheduledNotificationForAction,
          [actionId],
        ),
        returnValueForMissingStub: null,
      ) as _i3.FutureOr<(String, DateTime)?>);

  @override
  _i3.FutureOr<void> cancelScheduledNotificationForAction(String? actionId) =>
      (super.noSuchMethod(
        Invocation.method(
          #cancelScheduledNotificationForAction,
          [actionId],
        ),
        returnValueForMissingStub: null,
      ) as _i3.FutureOr<void>);
